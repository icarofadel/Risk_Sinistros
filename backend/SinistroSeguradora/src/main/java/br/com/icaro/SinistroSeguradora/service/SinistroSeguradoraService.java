...
public class SinistroSeguradoraService {
    ...
    public byte[] exportarParaExcel() {
        ...
        try (Workbook workbook = new XSSFWorkbook()) {
            ...
            header.createCell(1).setCellValue("Processo Seguradora");
            header.createCell(2).setCellValue("Segurado");
            header.createCell(3).setCellValue("Numero Apólice");
            header.createCell(4).setCellValue("Nota Fiscal");
            header.createCell(5).setCellValue("Conhecimento");
            header.createCell(6).setCellValue("Nome do cliente");
            header.createCell(7).setCellValue("Tipo de mercadoria");
            header.createCell(8).setCellValue("Valor Embarcado");
            header.createCell(9).setCellValue("Valor de NF");
            header.createCell(10).setCellValue("Estimativa de prejuizo");
            header.createCell(11).setCellValue("Natureza");
            header.createCell(12).setCellValue("Data da Ocorrência");
            header.createCell(13).setCellValue("Resumo");
            header.createCell(14).setCellValue("Pagador");
            header.createCell(15).setCellValue("Remetente");
            header.createCell(16).setCellValue("Cidade Origem");
            header.createCell(17).setCellValue("Destinatário");
            header.createCell(18).setCellValue("Cidade Destino");
            header.createCell(19).setCellValue("Nome Cia Aerea");
            header.createCell(20).setCellValue("AWB");
            header.createCell(21).setCellValue("Motorista");
            header.createCell(22).setCellValue("CPF");
            header.createCell(23).setCellValue("Placa");
