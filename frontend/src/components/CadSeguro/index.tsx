...
const Seguro = () => {
  const segurado = [
    {
      id: 1,
      nome: 'Empresa 1 LTDA - CNPJ 12.345.678/0001-90'
    },
    {
      id: 2,
      nome: 'Empresa 2 LTDA - CNPJ 98.765.432/0001-10'
    },
    { id: 3, nome: 'Empresa 3 LTDA - CNPJ 11.111.111/0001-11' }
  ]

  const nApolices: { [key: number]: string[] } = {
    1: [
      'RCTA-C - 5200000001 - 2022 x 2024',
      'RCTR-C - 5400000002 - 2022 x 2024',
      'RCF-DC - 5500000003 - 2022 x 2024',
      'RCTR-C - 5400000004 - 2024 x 2026',
      'RCF-DC - 5500000005 - 2024 x 2026',
      'RCTA-C - 5200000006 - 2024 x 2026'
    ],
    2: [
      'RCTA-C - 5200000002 - 2022 x 2024',
      'RCTR-C - 5400000002 - 2022 x 2024',
      'RCF-DC - 5500000003 - 2022 x 2024',
      'RCTR-C - 5400000004 - 2024 x 2026',
      'RCF-DC - 5500000005 - 2024 x 2026',
