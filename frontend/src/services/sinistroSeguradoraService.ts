...
const API_URL = 'http://localhost:8083/sinistroSeguradora'
...
export const buscarSinistroSeguradoraPorNF = async (notaFiscal: string) => {
  try {
...
export const exportarSinistrosExcelSeguradora = async () => {
  try {
    ...
    link.href = url
    link.setAttribute('download', 'sinistrosSeguradora.xlsx') // nome do arquivo
